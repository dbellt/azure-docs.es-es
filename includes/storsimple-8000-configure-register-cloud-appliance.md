...
2. En la hoja **Configurar dispositivo**, realice los siguientes pasos:
    ...
    1. Escriba la **Clave de cifrado de datos del servicio** en el espacio proporcionado para ello. Esta clave se genera cuando registra el primer dispositivo físico en su servicio StorSimple Device Manager.
