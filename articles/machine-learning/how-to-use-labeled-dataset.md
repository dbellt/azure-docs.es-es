...
* Para obtener un ejemplo de entrenamiento completo, consulte el [conjunto de datos con un cuaderno de etiquetas](/azure/machine-learning/how-to-use-labeled-dataset).
