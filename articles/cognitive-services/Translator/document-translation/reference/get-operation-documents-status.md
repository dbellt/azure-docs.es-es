---
title: Estado de documentos de operación Get de la traducción de documentos
titleSuffix: Azure Cognitive Services
description: El método de estado de documentos de operación Get devuelve el estado de todos los documentos en una solicitud de traducción de documento por lote.
...
ms.locfileid: "105613807"
---
# <a name="document-translation-get-operation-documents-status"></a>Traducción de documentos: estado de documentos de operación Get

El método de estado de documentos de operación Get devuelve el estado de todos los documentos en una solicitud de traducción de documento por lote.
...
## <a name="get-operation-documents-status-response"></a>Respuesta del estado de documentos de operación Get

### <a name="successful-get-operation-documents-status-response"></a>Respuesta correcta del estado de documentos de operación Get
