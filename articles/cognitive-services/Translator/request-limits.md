...
ms.locfileid: "107727949"
---
# <a name="request-limits-for-translator"></a>Límites de solicitudes de Translator

En este artículo se indican los límites para la traducción de Translator, la transliteración, la detección de la longitud de las oraciones, la detección de idiomas y las traducciones alternativas.
