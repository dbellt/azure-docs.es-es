...
> -  Si el diccionario contiene más de 250 000 oraciones, la traducción de documentos es una mejor opción. Consulte [Traductor de documentos](../document-translation/overview.md).
