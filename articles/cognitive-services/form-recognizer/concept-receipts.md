...
Azure Form Recognizer puede analizar y extraer información de recibos de ventas mediante sus modelos de recibos creados previamente. Combina nuestras poderosas funcionalidades de [reconocimiento óptico de caracteres (OCR)](../computer-vision/overview-ocr.md) con modelos de aprendizaje profundo para extraer información importante, como el nombre y el número de teléfono del comerciante o la fecha y el total de la transacción, entre otra mucha, de los recibos escritos en inglés.
