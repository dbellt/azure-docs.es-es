...
Esta base de referencia de seguridad aplica la guía de la [versión 1.0 de Azure Security Benchmark](../../security/benchmarks/overview-v1.md) en Windows Virtual Machines. Azure Security Benchmark proporciona recomendaciones sobre cómo puede proteger sus soluciones de nube en Azure. El contenido se agrupa en función de los **controles de seguridad** que define Azure Security Benchmark y la guía aplicable a Windows Virtual Machines.

> [!NOTE]
> Se han excluido los **controles** que no son aplicables a Windows Virtual Machines o cuya responsabilidad es de Microsoft. Para ver cómo Windows Virtual Machines se asigna por completo a Azure Security Benchmark, consulte el **[archivo completo de asignación de la base de referencia de seguridad de Windows Virtual Machines](https://github.com/MicrosoftDocs/SecurityBenchmarks/blob/master/Azure%20Offer%20Security%20Baselines/1.1/windows-virtual-machines-security-baseline-v1.1.xlsx)** .
...
- [Recopilación de registros y métricas de plataforma con Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/essentials/activity-log#view-the-activity-log)
...
- [Para capturar los datos de Syslog para la supervisión, deberá habilitar la extensión de Log Analytics](https://docs.microsoft.com/azure/azure-monitor/vm/quick-collect-azurevm#enable-the-log-analytics-vm-extension)
...
**Guía**: Windows Virtual Machines y Azure Active Directory (Azure AD) no tienen el concepto de contraseñas predeterminadas. El cliente es responsable de las aplicaciones de terceros y de los servicios de Marketplace que pueden usar contraseñas predeterminadas.
...
### <a name="36-use-secure-azure-managed-workstations-for-administrative-tasks"></a>3.6: Uso de estaciones de trabajo seguras y administradas por Azure para las tareas administrativas 
...
- [Cifrado del lado servidor de Azure Managed Disks](/azure/virtual-machines/windows/disk-encryption)

- [Azure Disk Encryption para máquinas virtuales Windows](/azure/virtual-machines/windows/disk-encryption-overview)
...
- [Solución Update Management de Azure](/azure/automation/overview)

- [Administración de actualizaciones y revisiones para las máquinas virtuales de Azure](/azure/automation/manage-updates-for-vm)
...
- [Carga de un VHD de máquina virtual personalizado en Azure](upload-generalized-managed.md)
...
**Guía**: use Microsoft Antimalware para Windows Virtual Machines en Azure para supervisar y proteger sus recursos de manera permanente.
