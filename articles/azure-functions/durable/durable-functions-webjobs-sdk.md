...
* Instale y ejecute un [emulador de Azure Storage](../../storage/common/storage-use-emulator.md). Una alternativa consiste en actualizar el archivo *App.config* con una cadena de conexión real de Azure Storage.
