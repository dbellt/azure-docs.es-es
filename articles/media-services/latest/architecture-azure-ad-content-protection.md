...
La notificación *groups* es miembro de un [conjunto de notificaciones restringidas](../../active-directory/develop/reference-claims-mapping-policy-type.md#claim-sets) de Azure AD.
