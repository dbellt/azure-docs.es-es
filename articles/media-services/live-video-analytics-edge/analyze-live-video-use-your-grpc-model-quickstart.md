---
title: 'Análisis de vídeo en directo con su propio modelo gRPC con Live Video Analytics: Azure'
description: En este inicio rápido, aplicará Computer Vision para analizar la fuente de vídeo en directo desde una cámara IP (simulada) con Live Video Analytics.
ms.topic: quickstart
ms.date: 08/14/2020
...
ms.locfileid: "110371739"
---
# <a name="quickstart-analyze-live-video-by-using-your-own-grpc-model-with-live-video-analytics"></a>Inicio rápido: Análisis de vídeo en directo con su propio modelo gRPC con Live Video Analytics
