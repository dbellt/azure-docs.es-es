...
Cree una tabla de rutas con [az network route-table create](/cli/azure/network/route-table#az_network_route_table_create). En el ejemplo siguiente se crea una tabla de rutas denominada *myRouteTablePublic*. 
