...
[Inicio de sesión en Azure](/cli/azure/reference-index#az_login).
...
[Crea un contacto](/cli/azure/hdinsight#az_hdinsight_create).
...
[Creación de una aplicación para un clúster de HDInsight](/cli/azure/hdinsight/application#az_hdinsight_application_create).
...
[Ejecución de acciones de script en el clúster de HDInsight especificado](/cli/azure/hdinsight/script-action#az_hdinsight_script_action_execute).
