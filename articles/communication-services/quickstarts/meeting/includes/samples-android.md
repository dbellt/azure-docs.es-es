...
Agregue `MeetingEventListener` a la clase.
...
Establezca `MeetingEventListener` en `this`.
...
Agregue `MeetingIdentityProvider` a la clase.
...
Establezca `MeetingIdentityProvider` en `this`.
