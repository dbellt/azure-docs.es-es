...
Si aún no ha implementado Simulación de dispositivo, vea [Implementación de Simulación de dispositivo](https://github.com/Azure/azure-iot-pcs-device-simulation/blob/master/README.md) en GitHub.
