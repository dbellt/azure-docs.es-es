...
:::image type="content" source="media/how-to-create-app-registration/app-important-values.png" alt-text="Captura de pantalla de la vista de Azure Portal en la que se muestran los valores importantes para el registro de la aplicación.":::
