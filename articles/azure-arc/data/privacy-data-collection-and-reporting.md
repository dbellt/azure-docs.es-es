...
Programa para la mejora de la experiencia del usuario (CEIP)|[Resumen del CEIP](/sql-server/usage-and-diagnostic-data-configuration-for-sql-server)|Automático, si está permitido|No
