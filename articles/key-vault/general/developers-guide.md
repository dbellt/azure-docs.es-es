...
Para obtener más información acerca del plano de administración de Key Vault, consulte [Plano de administración de Key Vault](security-overview.md).
...
Para obtener más información sobre el plano de datos de Key Vault, consulte [Información general de Key Vault](security-overview.md).
