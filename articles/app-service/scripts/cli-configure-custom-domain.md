...
| [`az webapp config hostname add`](/cli/azure/webapp/config/hostname#az_webapp_config_hostnam_eadd) | Asigna un dominio personalizado a una aplicación de App Service. |
