...
Para ello, vaya al servicio Azure API for FHIR y seleccione **Identidad.** Al cambiar el estado a **On,** se habilitará la identidad administrada en Azure API for FHIR Service.
...
Aquí es donde agregará el rol Colaborador de datos de [Storage Blob](../../role-based-access-control/built-in-roles.md#storage-blob-data-contributor) a nuestro nombre de servicio y, a continuación, seleccione **Guardar.**
...
El último paso consiste en asignar la cuenta de almacenamiento de Azure Azure API for FHIR usará para exportar los datos. Para ello, vaya a **Integración** en Azure API for FHIR servicio y seleccione la cuenta de almacenamiento.
