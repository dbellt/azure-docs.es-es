...
Para comprobar el modelo de cifrado de la cuenta de almacenamiento mediante la CLI de Azure, llame al comando [az storage account show](/cli/azure/storage/account#az_storage_account_show) y, después, compruebe la propiedad **keySource** de la cuenta.
