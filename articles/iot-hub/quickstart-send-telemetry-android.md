...
En esta sección, usará Azure Cloud Shell con la [extensión de IoT](/cli/azure/iot) para supervisar los mensajes de dispositivo que envía el dispositivo Android.
