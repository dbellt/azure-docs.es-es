...
1. Descargue o clone el repositorio azure-iot-samples-python mediante el botón **Código** en la [página del repositorio azure-iot-samples-python](https://github.com/Azure-Samples/azure-iot-samples-python/).
