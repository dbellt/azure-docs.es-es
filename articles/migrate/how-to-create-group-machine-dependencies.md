...
> [!Note]
> [Obtenga información](https://docs.microsoft.com/azure/azure-monitor/logs/private-link-security) sobre cómo configurar el área de trabajo de OMS para la conectividad de un punto de conexión privado.  
