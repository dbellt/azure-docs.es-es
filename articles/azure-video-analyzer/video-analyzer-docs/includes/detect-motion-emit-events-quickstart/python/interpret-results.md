...
- El valor **body** son datos sobre el evento de análisis. En este caso, el evento es de inferencia, por lo que el valor body contiene datos de **timestamp** e **inferences**.
