...
* Para información sobre el movimiento de los recursos a una nueva región, consulte [Movimiento de recursos entre regiones](move-resources-overview.md#move-resources-across-regions).
