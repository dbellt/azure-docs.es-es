...
También puede registrar proveedores de recursos con `az cli`. Para más información, consulte [Registro de dos proveedores para Kubernetes habilitado para Azure Arc](../azure-arc/kubernetes/quickstart-connect-cluster.md#register-providers-for-azure-arc-enabled-kubernetes).
