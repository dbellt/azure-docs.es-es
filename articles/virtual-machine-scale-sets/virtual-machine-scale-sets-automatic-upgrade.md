...
-   El [nivel de durabilidad](../service-fabric/service-fabric-cluster-capacity.md#durability-characteristics-of-the-cluster) de Service Fabric es Silver o Gold, no Bronze (excepto los tipos de nodo solo sin estado, que admiten actualizaciones automáticas del sistema operativo).
