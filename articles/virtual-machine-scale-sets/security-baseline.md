...
Esta línea base de seguridad aplica las guías descritas en [Azure Security Benchmark versión 1.0](../security/benchmarks/overview-v1.md) a Virtual Machine Scale Sets. Azure Security Benchmark proporciona recomendaciones sobre la forma en que puede proteger sus soluciones en la nube en Azure. El contenido se agrupa por los **controles de seguridad** definidos por Azure Security Benchmark y las guías relacionadas que se aplican a Virtual Machine Scale Sets.

> [!NOTE]
> Se han excluido los **controles** que no son aplicables a Virtual Machine Scale Sets o cuya responsabilidad es de Microsoft. Para ver cómo Virtual Machine Scale Sets se asigna por completo a Azure Security Benchmark, consulte el **[archivo completo de asignación de base de referencia de seguridad de Virtual Machine Scale Sets](https://github.com/MicrosoftDocs/SecurityBenchmarks/raw/master/Azure%20Offer%20Security%20Baselines/1.1/virtual-machine-scale-sets-security-baseline-v1.1.xlsx)** .
...
**Guía**: si usa el conjunto de escalado de máquinas virtuales para hospedar aplicaciones web, puede implementar Azure Application Gateway para las aplicaciones web con HTTPS/SSL habilitado para los certificados de confianza. Con Azure Application Gateway, puede dirigir el tráfico web de la aplicación a recursos específicos mediante la asignación de clientes de escucha a los puertos, la creación de reglas y la adición de recursos a un grupo de back-end, como conjunto de escalado de máquinas virtuales.
...
- [Descripción del área de trabajo de Log Analytics](/azure/azure-monitor/logs/get-started-queries)

- [Procedimiento para realizar consultas personalizadas en Azure Monitor](../azure-monitor/logs/log-analytics-tutorial.md)
...
**Guía**: el conjunto de escalado de máquinas virtuales de Azure y Azure Active Directory (Azure AD) no tienen el concepto de contraseñas predeterminadas. El cliente es responsable de las aplicaciones de terceros y de los servicios de Marketplace que pueden usar contraseñas predeterminadas.
...
**Guía**: configure opciones de diagnóstico para que Azure Active Directory (Azure AD) envíe registros de auditoría y de inicio de sesión a un área de trabajo de Log Analytics. Además, use Azure Monitor para revisar los registros y realizar consultas en los datos de registro de las máquinas virtuales de Azure.
...
- [Supervisión de máquinas virtuales en Azure](/azure/azure-monitor/vm/monitor-vm-azure)
...
**Guía**: los datos en tránsito hacia, desde y entre máquinas virtuales que ejecutan Windows se cifran de varias maneras en función de la naturaleza de la conexión, como durante la conexión a una máquina virtual en una sesión de RDP o SSH.
...
**Guía**: mediante el control de acceso basado en roles de Azure (Azure RBAC), puede repartir las tareas entre el equipo y conceder a los usuarios únicamente el nivel de acceso que necesitan en la máquina virtual (VM) para realizar su trabajo. En lugar de proporcionar a todos los empleados permisos no restringidos en la máquina virtual, puede permitir solo determinadas acciones. Puede configurar el control de acceso para la máquina virtual en Azure Portal, mediante la CLI de Azure o Azure PowerShell.
...
**Guía**: Azure Virtual Machine Scale Sets puede usar las actualizaciones automáticas de las imágenes del sistema operativo. Puede usar la extensión Desired State Configuration (DSC) de Azure para las máquinas virtuales subyacentes en el conjunto de escalado de máquinas virtuales. DSC se utiliza para configurar las máquinas virtuales a medida que se conectan, ya que ejecutan el software deseado.
...
- [Redes virtuales y máquinas virtuales en Azure](/azure/virtual-machines/windows/network-overview)
...
**Guía**: use la recomendación de corregir las vulnerabilidades en las configuraciones de seguridad de sus máquinas virtuales de Azure Security Center para mantener las configuraciones de seguridad en todos los recursos de proceso.
