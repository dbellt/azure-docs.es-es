...
- [Descripción del área de trabajo de Log Analytics](/azure/azure-monitor/logs/get-started-portal)
...
- [Supervisión de máquinas virtuales en Azure](/azure/azure-monitor/vm/monitor-vm-azur)
