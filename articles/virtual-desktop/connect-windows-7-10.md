...
ms.locfileid: "106447886"
---
# <a name="connect-with-the-windows-desktop-client"></a>Conexión con el cliente de Escritorio de Windows

Para acceder a los recursos de Windows Virtual Desktop en dispositivos con Windows 10, Windows 10 IoT Enterprise y Windows 7, use el cliente de escritorio de Windows. 
...
Los recursos agrupados por área de trabajo aparecerán en el **Centro de conexiones**.
   ...
   > [!NOTE]
   > De forma predeterminada, el cliente de Windows es Windows Virtual Desktop (clásico). 
   > 
